...
interface DefaultPayload<T> extends Record<string, T> {}
 ...
 */
export interface Message<MessagePayload = DefaultPayload<unknown>> {
  /**
 ...
 */
export interface ResponseMessage<MessagePayload = DefaultPayload<unknown>> extends Message<MessagePayload> {
}
 ...
 */
export interface NewMessage<MessagePayload = DefaultPayload<unknown>> extends Message<MessagePayload> {
  /**
